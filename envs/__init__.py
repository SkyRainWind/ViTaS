...
def make_env(
    ...
    **kwargs,
    ...
    def _init():
        if env_name in ["Door", "Stack", "Lift", "LiftCan", "LiftCap", "Wipe", "TwoArmPegInHole", "TwoArmHandover", "TrueTwoArmPegInHole", "PickPlace"]:
            ...
            elif env_name == "TrueTwoArmPegInHole":
                from robosuite.utils.placement_samplers import UniformRandomSampler
                # placement_initializer = UniformRandomSampler(
                #     name="ObjectSampler",
                #     mujoco_objects=None,
        ...
        elif env_name in ["HandManipulateBlockRotateZFixed-v1", "HandManipulateEggRotateFixed-v1", "HandManipulatePenRotateFixed-v1", "HandManipulatePenRotate-v1", "HandManipulatePenRotateFixedInst-v1"]:
        ...
        #     # action = random_state.uniform(spec.low, spec.high, spec.shape)
        #     timestep = env.step(action)
        #     # obs, reward, done, _ = env.step(action)
        #     print('qwq ', timestep)
        #     # print('qwq ', obs['image'].shape, reward, done)
        # exit(0)
